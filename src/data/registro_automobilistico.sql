...
insert into Proprietari values
       (01,'Lucchini','Valentina','Viale Pavia, 3','LO'),
       (02,'Farese','Giulia','Viale Italia, 9','LO'),
       (03,'Giovanolla','Filippo','Via G.Galilei, 4','LO'),
       (04,'Spoldi','Diego','Via Croce, 12','LO'),
       (05,'Spoldi','Simona','Via S.Angelo, 11','LO'),
       (06,'Bernocchi','Giuseppina','Via Pascoli, 1','LO'),
       (07,'Cottarelli','Cristian','Via Cannero, 18','MI');
...
insert into Proprietà values
       ('A123456X',01,'1994/6/20','2001/12/13'),
       ('B256787Y',01,'1996/4/20','2001/7/12'),
       ('C76589AG',02,'1999/7/31','2003/5/27'),
       ('F5789CY', 02,'2000/1/25','2005/12/13'),
       ('C78905GT',03,'1994/6/23','2003/2/17'),
       ('C845905Z',03,'1993/11/30','2001/1/6'),
       ('CFT340VB',04,'1996/9/16','2002/8/31'),
       ('D239765W',04,'1998/6/20','2005/5/25'),
       ('DD4567XX',05,'1994/6/9','2003/12/13'),
       ('DGH789JC',05,'1994/5/21','2003/5/28'),
       ('DH79567H',06,'1990/9/16','2007/12/16'),
       ('ERG567NM',06,'1999/10/11','2007/5/23'),
       ('F96154NH',07,'2000/3/15','2008/9/16'),
       ('FGH673FV',07,'1995/2/28','2005/12/25'),
       ('XCH56GJX',04,'1994/2/29','2001/4/13');
